...
We primarily use TailwindCSS for all CSS. For UI components, we leverage shadcn/ui, which is built on Tailwind CSS and Radix UI.
...
- Prefer using shadcn/ui components for common UI elements (buttons, inputs, cards, etc.).
- Customize shadcn/ui components via Tailwind CSS utility classes or by modifying the component source directly.
- Follow shadcn/ui's documentation for component usage and customization.