...
export const DEMO_CATEGORIES = {
  animations: {
    ...
    title: 'Animations',
    icon: '🎬',
    description: 'GPU-accelerated entrance animations and micro-interactions',
  },
  effects: {
    id: 'effects',
    title: 'Effects',
    icon: '✨',
    description: 'GPU-accelerated visual effects and polish',
  },
  interactive: {
    id: 'interactive',
    title: 'Interactive',
    icon: '🎯',
    description: 'Mouse and keyboard interaction patterns',
  },
  sections: {
    id: 'sections',
    title: 'Section Transitions',
    icon: '📄',
    description: 'Section-level content reveal patterns',
  },
  hoverStates: {
    id: 'hoverStates',
    title: 'Hover States',
    icon: '🎨',
    description: 'Cursor-responsive hover effects and feedback',
  },
  clickStates: {
    id: 'clickStates',
    title: 'Click/Active States',
    icon: '🖱️',
    description: 'Press, focus, and active state feedback',
  },
  mobileTouch: {
    id: 'mobileTouch',
    title: 'Mobile Touch',
    icon: '📱',
    description: 'Touch gestures with haptic-style feedback',
  },
  passiveStates: {
    id: 'passiveStates',
