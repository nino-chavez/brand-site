...
export const DEMO_CATEGORIES = {
  animations: {
    ...
    title: 'Animations',
    icon: '🎬',
    description: 'Smooth entrance animations that guide user attention and create professional polish',
  },
  effects: {
    id: 'effects',
    title: 'Effects',
    icon: '✨',
    description: 'Subtle visual enhancements that add depth without compromising performance',
  },
  interactive: {
    id: 'interactive',
    title: 'Interactive',
    icon: '🎯',
    description: 'Responsive controls that provide immediate feedback for user actions',
  },
  sections: {
    id: 'sections',
    title: 'Section Transitions',
    icon: '📄',
    description: 'Progressive content reveal that maintains engagement during scroll',
  },
  hoverStates: {
    id: 'hoverStates',
    title: 'Hover States',
    icon: '🎨',
    description: 'Clear affordance signals that help users discover interactive elements',
  },
  clickStates: {
    id: 'clickStates',
    title: 'Click/Active States',
    icon: '🖱️',
    description: 'Tactile feedback patterns that confirm user interactions',
  },
  mobileTouch: {
    id: 'mobileTouch',
    title: 'Mobile Touch',
    icon: '📱',
    description: 'Touch-optimized gestures with visual feedback for mobile users',
  },
  passiveStates: {
    id: 'passiveStates',
    title: 'Passive States',
    icon: '⏳',
    description: 'Non-intrusive loading patterns that maintain user confidence during waits',
  },
};
