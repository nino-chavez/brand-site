          ...
          <div className="flex flex-wrap gap-2">
            {searchHistory.map((historyQuery, i) => (
              <button
                ...
                className="px-4 py-1.5 bg-violet-50 text-violet-700 rounded-lg text-sm hover:bg-violet-100 transition-colors flex items-center gap-2"
              >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-4 mb-4">
                      <span className={`inline-flex items-center gap-1.5 px-4 py-1 rounded-full text-xs font-semibold border ${config.color}`}>
                        <span>{config.icon}</span>
                        {config.label}
                      </span>

                      <span className="inline-flex items-center gap-1.5 px-4 py-1 bg-gray-100 rounded-full text-xs font-medium text-gray-700">
