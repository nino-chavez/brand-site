...
export const DemoSidebar: React.FC<DemoSidebarProps> = ({
  ...
  return (
    <aside className="w-64 border-r border-white/10 bg-neutral-900/50 backdrop-blur-sm overflow-y-auto" data-testid="demo-sidebar">
      <div className="p-4">
        <h2 className="text-sm font-semibold text-white/40 uppercase tracking-wide mb-4">
          Categories
        </h2>
        ...
        <nav className="space-y-1">
          {categories.map((category) => (
            <button
              ...
              className={`relative w-full px-4 py-2 rounded-lg text-left flex items-center justify-between gap-2 transition-all duration-200 ${
