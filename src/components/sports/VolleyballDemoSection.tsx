        ...
        <div className="text-center mb-12">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-400">
              <span className="px-4 py-1 bg-gray-800 rounded-full">Frame-Perfect Synchronization</span>
              <span className="px-4 py-1 bg-gray-800 rounded-full">Visual Continuity System</span>
              <span className="px-4 py-1 bg-gray-800 rounded-full">Emotional Journey Mapping</span>
              <span className="px-4 py-1 bg-gray-800 rounded-full">Professional Photography Standards</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div className="bg-gray-800 bg-opacity-30 rounded-lg p-6 text-left">
              <h4 className="text-lg font-semibold text-white mb-4">Technical Documentation</h4>
            ...
            <div className="bg-gray-800 bg-opacity-30 rounded-lg p-6 text-left">
              <h4 className="text-lg font-semibold text-white mb-4">Client Presentations</h4>
              <p className="text-gray-300 text-sm">
            ...
            <div className="bg-gray-800 bg-opacity-30 rounded-lg p-6 text-left">
              <h4 className="text-lg font-semibold text-white mb-4">Educational Content</h4>
              <p className="text-gray-300 text-sm">
            ...
            <div className="bg-gray-800 bg-opacity-30 rounded-lg p-6 text-left">
              <h4 className="text-lg font-semibold text-white mb-4">Brand Communication</h4>
              <p className="text-gray-300 text-sm">
